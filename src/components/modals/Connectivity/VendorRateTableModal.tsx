...
export const VendorRateTableModal: React.FC<VendorRateTableModalProps> = ({
  ...
  // FIX: Reset filters and sort whenever modal is closed or vendor changes
  useEffect(() => {
    if (!isOpen) {
      setColumnFilters({});
      setApiFilters({});
  ...
  }, [isOpen, vendor, currentPage, rowsPerPage, apiFilters, sortConfig]);
      ...
      case "country_name":
        return (
          <FilterInput
            ...
            value={columnFilters["country_name"] || ""}
    ...
    >
      <div className="p-4 w-full flex flex-col">
        ...
        <ModalDataTable
          ...
          storageKey="connectivity_vendor_rates_modal_table"
          emptyMessage={Object.keys(apiFilters).length > 0 ? "No rates match your search filters." : "No rates found for this vendor."}
        />
      </div>
